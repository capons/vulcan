...
<section class="s-c">
    <div id="main-contant" class="container">
        <div class="row r-cont">
                <div class="col-lg-8 c-main room">
                    <div class="c-container">
                        <div class="col-xs-12 content-m-block">
                            <img src="image/img_of.png" alt="alt">
                        </div>
                    </div>
                    <h5 class="m-container-title page">Lerual IpsunLerual IpsunLerual Ipsun</h5>
                </div>
            <div class="col-lg-12">
            ...
            <div style="text-align: center" class="col-lg-12">
                <form id="h_readm_form" action="" method="post">
                    <input type="hidden">
                    <input id="h_readm_b" type="submit" value="">
                </form>
            </div>
        </div>
