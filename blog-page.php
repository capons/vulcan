                ...
                <div style="margin-top: 40px" class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-xs-9">
                            ...
                            <p class="text">Сайт рыбатекст поможет дизайнеру, верстальщику, вебмастеру сгенерировать несколько абзацев более менее осмысленного текста рыбы на русском языке, а начинающему оратору отточить навык публичных выступлений в домашних условиях</p>
                            <div class="row">
                                <div class="col-xs-12">
                                    <form id="h_readm_form_blog" action="http://localhost/bogdan/Vulcan/articles-block.php" method="post">
                                        <input type="hidden">
                                        <input id="h_readm_b_blog" type="submit" value="">
                                    </form>
                                    <span class="s-more">22 апреля 2016г.</span>
                                </div>
                            </div>
                        </div>
                    </div>
